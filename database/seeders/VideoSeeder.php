    ...
    public function run(): void
    {
        $videos = [
            ['title' => 'মহালছড়ি বাজারে ২৩ দোকান পুড়ে ছাই — সরেজমিনে ক্ষতিগ্রস্ত ব্যবসায়ীদের কান্না',
             'url' => 'https://www.facebook.com/share/v/19Xg5B3P78/', 'duration' => '৪:১৫', 'reel' => false, 'views' => 22400,
            ...
            ['title' => 'বানভাসি মানুষের দোরগোড়ায় সেনাবাহিনী — নদীপথে চিকিৎসা ও ওষুধ বিতরণ',
             'url' => 'https://www.facebook.com/share/v/1Ber5oogFd/', 'duration' => '৩:০৫', 'reel' => true, 'views' => 18730,
            ...
            ['title' => 'মাইসছড়িতে বজ্রপাতে স্বামী-স্ত্রীর মৃত্যু — পরিবারে শোকের ছায়া',
             'url' => 'https://www.facebook.com/share/v/14mVcr6iSDs/', 'duration' => '২:২০', 'reel' => true, 'views' => 15200,
            ...
            ['title' => 'মহালছড়ি সেনা জোনের বিনামূল্যে চক্ষু ক্যাম্প — ৫৬৮ জনের চোখ পরীক্ষা',
             'url' => 'https://www.facebook.com/share/v/1CY2kvyRSY/', 'duration' => '৫:১২', 'reel' => false, 'views' => 9300,
            ...
            ['title' => 'পাহাড়ধসে মহালছড়ি-জালিয়াপাড়া সড়ক বন্ধ — ড্রোনে ক্ষতিগ্রস্ত সড়কের চিত্র',
             'url' => 'https://www.facebook.com/share/v/1BGLr3jiCs/', 'duration' => '২:৪৮', 'reel' => false, 'views' => 11200,
            ...
            ['title' => 'মহালছড়ি-সিন্দুকছড়ি সড়কে পর্যটনের হাতছানি — ধুমনীঘাট ঝরনায় পর্যটকদের ভিড়',
             'url' => 'https://www.facebook.com/share/v/19RNHFTGiQ/', 'duration' => '৪:৩০', 'reel' => false, 'views' => 15600,
            ...
            ['title' => 'সকল সম্প্রদায়ের সমন্বয়ে মহালছড়িতে সম্প্রীতি কাপ ফুটবল টুর্নামেন্টের উদ্বোধন',
             'url' => 'https://www.facebook.com/share/v/1LEHRuMaiE/', 'duration' => '২:৩৩', 'reel' => false, 'views' => 12450,
             'desc' => 'পাহাড়ি ও বাঙালি সব সম্প্রদায়ের সমন্বয়ে ১৬ দলের অংশগ্রহণে সম্প্রীতি কাপ ফুটবল টুর্নামেন্ট ২০২৬।'],

            ['title' => 'প্রস্তুতি সম্পন্ন: জমকালো আয়োজনে মহালছড়ি সম্প্রীতি ফুটবল কাপ ২০২৬',
             'url' => 'https://www.facebook.com/share/r/19DAvp2XJe/', 'duration' => '০:৫৯', 'reel' => true, 'views' => 9120,
             'desc' => 'জমকালো আয়োজনে অনুষ্ঠিত হবে মহালছড়ি সম্প্রীতি ফুটবল কাপ টুর্নামেন্ট ২০২৬-এর উদ্বোধনী অনুষ্ঠান।'],
        ];
