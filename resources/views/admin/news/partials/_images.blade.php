...
<div class="mc-card p-4 sm:p-5">
    ...
    <p class="mc-tip mb-4">
        ছবি সরাসরি হোস্টিং API তে আপলোড হয় ({{ $imageProvider['provider_label'] ?? 'সার্ভার স্টোরেজ' }}),
        ডাটাবেসে শুধু রেফারেন্স থাকে — কোনো লিংক UI-তে দেখানো হয় না।
    </p>
...
<div class="mc-card p-4 sm:p-5">
    ...
    <p class="mc-tip mb-4">
        একসাথে {{ bn_num($maxUploads) }}টি পর্যন্ত ছবি আপলোড করা যায় (প্রতিটি সর্বোচ্চ {{ bn_num(intdiv($maxUploadKb, 1024)) }} MB)।
